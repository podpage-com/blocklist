...
class Observation(models.Model):
    class Reason(models.TextChoices):
        SIGNUP_ABUSE="signup_abuse","Signup abuse"
        SPAM="spam","Spam"
        SCRAPING="scraping","Scraping"
        CREDENTIAL_ABUSE="credential_abuse","Credential abuse"
    ...
    class Meta:
        ...
        indexes=[models.Index(fields=["ip_address","active"]),models.Index(fields=["updated_at"]),models.Index(fields=["expires_at"])]
